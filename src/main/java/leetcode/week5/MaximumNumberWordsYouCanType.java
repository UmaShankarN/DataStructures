...
public class MaximumNumberWordsYouCanType {
	...
	/*
	 * initialise a wordcount variable to store the output count
	 * iterate through each word of the given text string
	 * initialise a counter variable with 0
	 * iterate through each character of broken letters
	 * increment the counter if the broken letter is found in the current word
	 * verify if the counter is equal to the length of broken letters and increment the wordcount
	 * return the word count once all the words in the given text is verified
	 * 
	 */
